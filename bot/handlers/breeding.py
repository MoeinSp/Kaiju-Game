...
def _cave_guide_text() -> str:
    ...
    div = "──────────────"
    dna_lines = "\n".join(f"• {constants.RARITY_LABELS[r]}: {constants.BREEDING_DNA_COST[r]}" for r in ro)
    return "\n".join([
        "📖 <b>راهنمای غار هیولا</b>",
        "",
        "🥚 <b>فرایند جفت‌گیری</b>",
        "• دو هیولای آزاد را انتخاب می‌کنی؛ جفت‌گیری انجام می‌شود (والدها مصرف/آزاد می‌شوند) و یک "
        "تخم جدید به دست می‌آید که پس از رشد مشخص، باز خواهد شد.",
        "", div, "",
        "🎲 <b>فرمول رده‌ی تخم</b>",
        "رده‌ی نوزاد هرگز بالاتر از والدین نخواهد رفت و بر اساس قوانین زیر محاسبه می‌شود:",
        "• والدین هم‌رده: ۵۰٪ شانس دریافت همان رده | ۵۰٪ شانس یک رده پایین‌تر",
        "• والدین متفاوت‌رده: ۹۰٪ شانس رده‌ی پایین‌تر | ۱۰٪ شانس رده‌ی بالاتر",
        "", div, "",
        ...
        "", div, "",
        "🧬 <b>هزینه DNA</b> <i>(بر اساس نایاب‌ترین والد)</i>",
        dna_lines,
        "", div, "",
