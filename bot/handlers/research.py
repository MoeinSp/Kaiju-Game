...
def _panel_text(lab_level: int) -> str:
    if lab_level <= 0:
        return (
            "🔬 <b>آزمایشگاه</b>\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            "اینجا با پژوهش روی عناصر و توانایی‌ها به <b>همه‌ی هیولاهات</b> تقویت همیشگی می‌دی.\n\n"
            "⛔ <i>هنوز ساختمونِ «🔬 آزمایشگاه» رو نساختی — از سطح <b>۵ تالار مِهر</b> باز می‌شه. "
            "اول از بخش «ساختمون‌ها» بسازش.</i>"
        )
    return (
