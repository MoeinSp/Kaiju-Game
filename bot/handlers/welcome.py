...
def _build_welcome_text() -> str:
    ...
    return (
        ...
        "🙏 <b>یه خواهش کوچیک:</b> لطفاً من رو <b>ادمین</b> کن — ولی <b>فقط دسترسی‌های لازم</b> رو بده، "
        "همین‌قدر که بتونم پیام‌های اضافه رو <b>حذف</b> کنم کافیه.\n"
        "<blockquote>🔒 خیالت راحت: به دسترسی‌های حساس مثل <b>بن/محدودکردن اعضا</b>، افزودن ادمین یا "
        "تغییر تنظیمات گروه <b>هیچ نیازی ندارم</b> — می‌تونی موقع ادمین‌کردن همه‌شون رو خاموش بذاری و فقط "
        "«حذف پیام‌ها» رو روشن کنی. ادمین‌بودن فقط برای اینه که تلگرام کلمه‌های شما رو به من برسونه.</blockquote>"
    )
