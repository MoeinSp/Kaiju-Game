...
def _build_welcome_text() -> str:
    ...
    return (
        ...
        "🙏 <b>یه خواهش:</b> لطفاً من رو <b>ادمین</b> کن تا بتونم پیام‌های اضافه رو حذف کنم.\n"
        "<blockquote>🔒 فقط «حذف پیام‌ها» رو روشن کن — به هیچ دسترسی حساسی (بن، افزودن ادمین، تنظیمات) "
        "نیاز ندارم. ادمین‌بودن فقط برای اینه که تلگرام کلمه‌های شما رو به من برسونه.</blockquote>"
    )
