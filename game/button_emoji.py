...
BUTTON_EMOJI_DEFS: dict[str, tuple[str, str, str]] = {
    ...
    # 🔬 research-lab: the panel button + one icon per research track
    "btn_research": ("آزمایشگاه", "🔬", "features"),
    "btn_rsch_fire": ("پژوهش آتش", "🔥", "action"),
    "btn_rsch_water": ("پژوهش آب", "💧", "action"),
    "btn_rsch_earth": ("پژوهش خاک", "🪨", "action"),
    "btn_rsch_electric": ("پژوهش برق", "⚡", "action"),
    "btn_rsch_might": ("پژوهش خشم", "⚔️", "action"),
    "btn_rsch_vigor": ("پژوهش سرزندگی", "❤️", "action"),
    ...
    "btn_help": ("راهنما", "📖", "nav"),
    "btn_stats": ("آمار کلی", "📊", "admin"),
    "btn_gift": ("هدیه به همه", "🎁", "admin"),
    "btn_chat": ("گروه بازی", "🎮", "admin"),
    "btn_recycle": ("تبدیل و بازیافت", "♻️", "action"),
    "btn_cave_info": ("اطلاعات غار", "🎲", "action"),
    "btn_time_info": ("زمان‌های غار", "⏱", "action"),
    "btn_confirm_pay": ("تأیید پرداخت", "💳", "confirm"),
    "btn_ally_join": ("عضویت در اتحاد", "➕", "action"),
