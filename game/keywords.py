...
KEYWORD_DEFS: dict[str, tuple[str, str, str, tuple[str, ...]]] = {
    ...
    "exchange": (
        ...
        "مبادله‌ی طلا و DNA",
        (
            "طلا و DNA رو با هم عوض می‌کنی — همه‌چیز با دکمه و تأیید نهایی.",
            "می‌تونی با طلا DNA بخری، یا DNA رو برای طلا بفروشی.",
            "نرخ‌ها ثابتن و رفت‌وبرگشت یه‌کم ضرر داره، پس فقط برای وقتیه که لازمت شه.",
