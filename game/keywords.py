...
KEYWORD_DEFS: dict[str, tuple[str, str, str, tuple[str, ...]]] = {
    ...
    "creature": (
        ...
        "کارت هیولای فعالت",
        (
            "هیولای «فعال» همونیه که توی همه‌ی نبردها می‌جنگه — شکار، آرنا و حمله به باس.",
    ...
    "select": (
        ...
        (
            ...
            "هیولای فعال توی همه‌ی نبردها می‌جنگه: اتک، شکار و نبرد.",
    ...
    "upgrade": (
        "ارتقا",
        "settings",
        "تغذیه و ارتقای هیولا",
        (
            "🍽 تغذیه: با «غذای هیولا» (موش/مرغ/گربه) به هیولات XP می‌دی — از «فروشگاه روزانه» می‌خری یا از جایزه‌ها می‌گیری.",
            "سه نوع غذا هست (موش/مرغ/گربه) با XP متفاوت؛ می‌تونی «همه» رو یکجا بدی بخوره.",
            "با XP، هیولا سطح می‌گیره و هر سطح استت‌هاش بالا می‌ره.",
            "ارتقای اعضای بدن (بال، زره، نیش، زهر) هم همین‌جا و هم توی پیوی انجام می‌شه.",
        ),
    ),
    "lab": (
        "آزمایشگاه",
    ...
    "arena": (
        ...
        (
            ...
            "بردن: کاپ می‌گیری و بخشی از طلای حریف رو غارت می‌کنی. باختن: فقط کاپ از دست می‌دی (طلات سالمه).",
    ...
    "attack": (
        ...
        (
            ...
            "روی باس: دمیجت سهم غنیمتت رو تعیین می‌کنه. روی بازیکن: اگه ببری طلا غارت می‌کنی؛ اگه ببازی هیچی ازت کم نمی‌شه (اتک گروهی کاپ نداره).",
        ),
    ),
    # ── economy ─────────────────────────────────────────────────────────────
    "mine": (
    ...
    "box": (
        ...
        (
            ...
            "باکس هیولا (پیوی) گرون‌تره ولی همیشه هیولا می‌ده و شانس بهتری داره.",
        ),
    ),
    "wheel": (
        "گردونه",
    ...
    "exchange": (
        ...
        "مبادله‌ی طلا و DNA",
        (
            "اول انتخاب می‌کنی چی می‌خوای بخری: طلا یا DNA.",
            "بعد مقدار رو با دکمه یا «عدد دلخواه» می‌ذاری و تأیید می‌کنی.",
            "نرخ: هر ۵۰ طلا = ۱ DNA · هر ۱ DNA = ۲۵ طلا.",
            "همین‌جا توی گروه هم کار می‌کنه — فقط خودت می‌تونی دکمه‌هاش رو بزنی.",
        ),
    ),
    ...
    "fusion": (
        ...
        (
            ...
            "سقف ستاره = سطح «تالار ادغام» توئه (لِوِل ۲ برای ۲⭐، ۳ برای ۳⭐ …). انجامش توی پیویه.",
        ),
    ),
    "breeding": (
        "غار",
    ...
    "expedition": (
        "اعزام",
        "battle",
        "مأموریت تیمی و اعزام کاروان",
        (
            "اعزام کاروان ۲ تا ۴ نفره برای کاوش مناطق خطرناک و دریافت غنائم مشترک.",
            "سایر بازیکنان با دکمه «پیوستن» ملحق می‌شوند و سرپرست دستور حرکت می‌دهد.",
