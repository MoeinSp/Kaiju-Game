...
KEYWORD_DEFS: dict[str, tuple[str, str, str, tuple[str, ...]]] = {
    ...
    "upgrade": (
        ...
        (
            "🧪 تغذیه: با «کپسول اکسپی» به هیولات XP می‌دی — کپسول‌ها رو از «فروشگاه روزانه» می‌خری.",
            "سه نوع کپسول هست (کوچک/متوسط/بزرگ) با XP متفاوت؛ می‌تونی «همه» رو یکجا مصرف کنی.",
